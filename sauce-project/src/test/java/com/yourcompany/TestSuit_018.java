...
public class TestSuit_018 implements SauceOnDemandSessionIdProvider {
    ...
    public TestSuit_018(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Chartlytics Test_AddPinpointToGroup");
	...
	Orgname=getit[0][4];
	 ...
	 @Test 
	//--------------------------------------------------------------------------------------------
 public void AddPinpointToGroup() throws Exception {
    ...
    String[][] creatgroup = GetValue(Pathofexcel,"group",40);
...
//---------------------------------------------------Add Pinpoint To Group-------------------------------------------------------------//
    String[][] assignPin = GetValue(Pathofexcel,"group",43);
	String pinName = assignPin[0][0];
    ...
    Thread.sleep(3000);
    driver.findElement(By.id("launchAssignPinpointToGroup")).click();
   // driver.findElement(By.id("launchAssignPerformer")).click();
    ...
    Thread.sleep(2000);
    driver.findElement(By.cssSelector(".select2-input.select2-focused")).sendKeys(pinName);
    Thread.sleep(2000);
    driver.findElement(By.cssSelector(".select2-result-label")).click();
    Thread.sleep(2000);
    driver.findElement(By.id("assignPinpointToGroup")).click();
    Thread.sleep(5000);
   String assPinName = driver.findElement(By.xpath("..//*[@id='grid-view']/div[1]/a/div/div/div[1]/h2")).getText();
   System.out.println("//-----------------------------Pinpoint Name-------------------------------//");
   System.out.println(assPinName);
  }
