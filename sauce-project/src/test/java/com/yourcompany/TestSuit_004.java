...
public class TestSuit_004 implements SauceOnDemandSessionIdProvider{
  ...
  for(int y=14;y<=17;y++){
 		 String[][] data = GetValue("./src/dataexcel.xlsx","performer",y);
...
//    	    		System.out.println("click on name z to a ");
    ...
    //if NameAtoZ button is Y in the excel sheet 
    	driver.findElement(By.xpath("//*[@id='app-main']/div[2]/div[1]/div/div[3]/label[1]")).click();
...
//    		System.out.println("click on name a to z ");
 ...
 }// end of test  public void testSort() throws Exception {
	  PropertyConfigurator.configure("./log/log4j.properties");
		String[][] getit = GetValue("./src/dataexcel.xlsx","signup",2);
		 baseUrl = getit[0][0]; 
		 Email= getit[0][2];  
