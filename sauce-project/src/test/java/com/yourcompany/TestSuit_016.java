...
public class TestSuit_016 implements SauceOnDemandSessionIdProvider {
    ...
    public TestSuit_016(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Chartlytics Test_AssignPinpointToperformer");
  ...
  String[][] getits = GetValue(Pathofexcel,"assignpinpoint",2);
...
//-------------------------------------------------Create Pinpoint--------------------------------------------------------------------//
    ...
    String[][] datas = GetValue(Pathofexcel,"assignpinpoint",8);
...
//------------------------------------------------------------Select the combination for "Set Default" tab--------------------------------------------------------------------//	    
	    String[][] data = GetValue(Pathofexcel,"assignpinpoint",11);
...
//-------------------------------------------------------------------------"Assign pinpoint" to perforemer-------------------------------------//
			    String[][] pinpnt = GetValue(Pathofexcel,"assignpinpoint",15);
