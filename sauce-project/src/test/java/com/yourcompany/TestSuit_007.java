...
public class TestSuit_007 implements SauceOnDemandSessionIdProvider {
    ...
    public TestSuit_007(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Chartlytics Test_CreateGroup");
